     ...
     <header class="header dark-bg">
       ...
       <div class="nav search-row" id="top_menu">
         ...
         <!-- <ul class="nav top-menu">
           <li>
             <form class="navbar-form" action="<?php echo base_url('Cperusahaan/Lamaran'); ?>" method="get">
           ...
           <div>
             <header class="panel-heading">
               ...
               <table class="table table-striped table-advance table-hover">
                 <tbody>
                   <tr>
                     <th><i class="icon_location"></i> Foto </th>
                     <th><i class="icon_location"></i> NIK </th>
                     <th><i class="icon_location"></i> Nama Lengkap</th>
                     <th><i class="icon_location"></i> Tanggal Lahir</th>
                     <th><i class="icon_location"></i> Jenis Kelamin</th>
                     <th><i class="icon_location"></i> Email</th>
                     <th><i class="icon_location"></i> No Telepon</th>
                   </tr>
                   <?php foreach ($lamaran as $LWG){ ?>
                   <tr>
                     <td><img  width="70" height="90"  src="<?php echo base_url('uploads/'.$LWG->foto) ?>"></img></td>
                     <td><?php echo $LWG->nik;?></td>
                     <td><?php echo $LWG->namaLengkap;?></td>
                     <td><?php echo $LWG->tglLahir;?></td>
                     <td><?php echo $LWG->jenisKelamin;?></td>
                     <td><?php echo $LWG->email;?></td>
                     <td><?php echo $LWG->noTel;?></td>
                     <td><a class="btn btn-success" href="<?php echo base_url ('Chome/detailProfilPelamar/'.$LWG->nik.'/'.$LWG->id_lowongan); ?>">Lihat Profil Pencaker</a></td>
                   </tr>
                 <?php }?>
                 </tbody>
               </table>

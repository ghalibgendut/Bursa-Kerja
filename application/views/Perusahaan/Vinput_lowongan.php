  ...
  <section id="container" class="">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?=base_url('Cperusahaan/lowongan')?>" enctype="multipart/form-data">
                    <?php foreach ($perusahaan as $k) { ?>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">No Siup <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="No_Siup" minlength="5" type="text" value="<?php echo $k->no_siup; ?>" readonly />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Nama Perusahaan <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="Nama_Perusahaan" minlength="5" type="text" value="<?php echo $k->nama_perusahaan; ?>" required />
                      </div>
                    </div>
                  <?php } ?>
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control " id="cname" type="text" name="Nama_lowongan" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Jabatan</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="cname" type="text" name="Jabatan" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <!-- <select class="form-control m-bot15" name="Jenis_Kelamin"> -->
                          <input type="checkbox" name="Jenis_Kelamin[]" alt="Checkbox" value="Laki-laki"> Laki-laki
                          <input type="checkbox" name="Jenis_Kelamin[]" alt="Checkbox" value="Perempuan"> Perempuan
                        <!-- </select> -->
                      </div>
                    </div>
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control " id="cname" type="text" name="Pengalaman" required />
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control uang" id="ccomment" name="Gaji" ></input>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <div class="input-prepend">
                          <input id="reservation" class=" form-control" name="tgl_pendaftaran" type="text">
                        </div>
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Poster Lowongan</label>
                      <div class="col-sm-10">
                        <input type="file" placeholder="Poster Lowongan" name="poster">
                      </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="text-right">
      <div class="credits">
          ...
          -->
          Designed by <a href="https://bootstrapmade.com/">Ar-raniry Muhammad</a>
        </div>
    </div>
  </section>

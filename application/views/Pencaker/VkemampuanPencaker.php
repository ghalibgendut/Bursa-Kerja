       ...
       <section class="wrapper">
         ...
         <div class="row">
           ...
           <div>
             ...
             <form class="form-horizontal" action="<?php echo base_url('Cpencaker/kemampuan'); ?>" method="post" enctype="multipart/form-data">
               ...
               <?php } ?>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Nama Kemampuan</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control round-input" name="namaKemampuan" required>
                 </div>
               </div>
               <div class="form-group">

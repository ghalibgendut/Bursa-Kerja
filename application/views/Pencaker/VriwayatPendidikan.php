         ...
         <div class="row">
           <div class="col-lg-12">
             ...
             <ol class="breadcrumb">
               ...
               <li><i class="fa fa-laptop"></i>Riwayat Pendidikan</li>
             </ol>
           </div>
           <div>
             ...
             <form class="form-horizontal" action="<?php echo base_url('Cpencaker/riwayatPendidikan'); ?>" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-2">
                   <select class="form-control m-bot15" name="tingkat" required>
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input type="text" class="form-control round-input" placeholder="Nama Sekolah" name="namaSekolah" required>
                 </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input type="text" class="form-control round-input" placeholder="Alamat Sekolah" name="alamatSekolah" required>
                 </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input type="file" placeholder="Foto Ijazah" name="fotoIjazah">
                 </div>
               </div>
               <p align="right">

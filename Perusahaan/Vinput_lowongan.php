          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?=base_url('Cperusahaan/lowongan')?>">
                    <?php foreach ($perusahaan as $k) { ?>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">No Siup <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="No_Siup" minlength="5" type="text" value="<?php echo $k->no_siup; ?>" disabled required />
                      </div>
                    </div>
                    <div class="form-group ">
                  ...
                  <?php } ?>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control " id="ccomment" name="Gaji" ></input>
                      </div>
                    </div>
                    <div class="form-group">

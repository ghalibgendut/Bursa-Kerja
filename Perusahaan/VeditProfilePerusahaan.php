         ...
         <div class="row">
           ...
           <div>
             ...
             if (validation_errors()) {
              ...
              ?>
             <form class="form-horizontal" action="<?php echo base_url('Cperusahaan/updateProfil'); ?>" method="post" enctype="multipart/form-data">
               <?php foreach ($perusahaan as $k) { ?>
               <div class="form-group">
                 <label class="col-sm-2 control-label">NO SIUP</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control round-input" placeholder="No SIUP" name="no_siup" value="<?php echo $k->no_siup; ?>" disabled>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Nama Perusahaan</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control round-input" placeholder="Nama Perusahaan" name="nama_perusahaan" value="<?php echo $k->nama_perusahaan; ?>" required>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">E-Mail</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control round-input" placeholder="E-Mail" name="email" value="<?php echo $k->email; ?>"required>
                 </div>
               </div>
               <div class="form-group">
